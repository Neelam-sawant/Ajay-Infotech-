    ...
    <div class="container-fluid bg-dark px-5 d-none d-lg-block">
      <div class="row gx-0" >
          ...
          <div class="col-lg-4 text-center text-lg-end">
              <div class="d-inline-flex align-items-center" style="height: 45px;">
                  <a class="me-3 text-light" href="career.php"><i class=""></i>Career</a>
                  <a class="me-3 text-light" href="downloadpage.php"><i class=""></i>Download</a>
              </div>
          </div>
      </div>
  </div>
  ...
  <div class="container-fluid position-relative p-0">
      <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0 " style="background-color: #003B64;">
          <a href="index.php" class="navbar-brand p-0">
              <h1 style="margin-left:30px;"><i class="fa  me-2"><img style="height: 5;width: 50px; margin: left 10px;" src="img\AILOGO.png" alt=""> </i>Ajay Infotech</h1>
          </a>
        ...
        <div class="row gx-2"> <!-- Added gx-2 for horizontal spacing -->
            ...
            <div class="col-4">
                ...
                <a href="tsynchronization.php" class="dropdown-item">Tally Synchronization</a>
                  ...
                  <div class="nav-item dropdown">
    <a href="gem/index-5.1.html" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Gemlyte</a>
    <div class="dropdown-menu p-3" aria-labelledby="navbarDropdown" style="width: 400px;">
        <div class="row">
            <!-- Web Development Section -->
            <div class="col-md-6">
                    <h6 class="dropdown-title">Web Development</h6>
            ...
            <div class="col-md-6">
                ...
                <p class="dropdown-item">Poster</p>
                ...
                <p class="dropdown-item">Banner</p>
                  ...
                  <div class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu m-0">
                          ...
                          <a href="blogdetails.php" class="dropdown-item">Blog Detail</a>
                      </div>
                  </div>
